...
const StoryModal = ({setShowModal,fetchStories}) => {
  ...
  return (
    <div className='fixed inset-0 z-110 minh-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4 '>
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relativev' style={{backgroundColor:background}}>
                {
                    mode==='text' && (
            ...
            <div className='flex gap-2 mt-4'>
                ...
                <label className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer ${mode==='media'?"bg-white text-black":"bg-zinc-800"} `}>
                    <input onChange={(e)=>{handleMediaUpload(e);setMode('media')}} type="file" accepts="image/*, video/*" className='hidden' />
