  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* Tabs  */}
        <div className=' inline-flex flex-wrap items-center border border-gray-200 rounded-md p1 bg-white shadow-sm '>
          {
            dataArray.map((tab)=>(
                  ...
                  <div className='flex max-sm:flex-col gap-2 mt-4'>
                    ...
                    }
                    {
                      currentTab === "Following" && (
                        <button className='w-full p-2 text-sm rounded bg-slate-100 hoover:bg-slate-200 text-black active:scale-95 transition cursor-pointer '>
                          Unfollow
                        </button>
                      )
                    }
                    ...
                    }
                    {
                      currentTab === "Connections" && (
                        <button onClick={()=> navigate(`/messages/${user._id}`)} className='w-full p-2 text-sm rounded bg-slate-100 hoover:bg-slate-200  text-slate-800 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1'>
